...
Note: spnkr_import_db.py a été archivé dans scripts/_archive/ (Sprint 1).
Ce script est remplacé par sync.py + DuckDBSyncEngine.
"""
...
# spnkr_import_db.py archivé dans scripts/_archive/ (Sprint 1)
sys.path.insert(0, "scripts/_archive")
